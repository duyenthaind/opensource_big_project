...
<div class="humberger__menu__wrapper">
    ...
    <nav class="humberger__menu__nav mobile-menu">
        <ul>
            ...
            <li><a href="${server}/shop-grid?categoryId=-1&page=0&searchText=&typeSearch=name&operator=LIKE">Shop</a>
            </li>
            <li><a href="#">Pages</a>
        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="hero__categories">
                    ...
                    <ul style="${display}">
                        <li><a href="${server}/shop-grid?categoryId=-1&page=0&searchText=&typeSearch=name&operator=LIKE">Shopping</a>
                        </li>
                ...
                <div class="hero__search">
                    <div class="hero__search__form">
                        <form action="${server}/shop-grid-search" method="GET">
                            ...
                            <input type="hidden" id="categoryIdToSearch" value="-1" name="categoryId"/>
