	...
	<div class="humberger__menu__wrapper">
		...
		<div class="humberger__menu__cart">
			<ul>
				...
				<li><a href="#"><i class="fa fa-shopping-bag"></i> <span class="totalCart">0</span></a></li>
			</ul>
				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-6">
						<div class="header__top__right">
							...
							<div id="validateAccount" class="header__top__right__auth">
								<div class="dropdown show">
									<a class="accountlink dropdown-toggle" href="#" id="accountDiv"
										role="button" id="dropdownMenuLink" data-toggle="dropdown"
										aria-haspopup="true" aria-expanded="false"> Account </a>

									<div id="selectionDiv" class="dropdown-menu"
							...
							<div class="header__top__right__auth" id="logoutDiv">
								<a href="/signup"><i class="fa fa-sign-in"></i> Sign up</a>
							</div>
						</div>
					</div>
				</div>
