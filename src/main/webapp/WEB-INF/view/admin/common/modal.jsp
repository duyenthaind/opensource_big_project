						...
						<div class="card">
							...
							<div class="card-body">
								...
								<form method="POST" enctype="multipart/form-data"
									...
									<div class="form-group has-success">
										<label for="cc-name" class="control-label mb-1">Description</label>
										<textarea id="description" class="summernote" rows="4" cols="40" name="description"></textarea>
										<span class="help-block field-validation-valid"
											data-valmsg-for="cc-name" data-valmsg-replace="true"></span>
									</div>
									...
									<div>
									<input type="hidden" id="currentPageCate" name="currentPageCate" />
...
<div class="modal fade" id="confirmDeleteCategory" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<button type="button" id="buttonDeleteCategory" class="btn btn-primary">Delete</button>
			<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
			</div>
		</div>
