...
@
keyframes scales {from { transform:scale(0.98);
 ...
 */
@
-webkit-keyframes flicker-4 { 0%, 100% {
	opacity: 1;
}
 ...
 */
@
-webkit-keyframes wobble-ver-right { 0%, 100% {
...
<body>
    ...
    <g fill="none" fill-rule="evenodd">
      ...
      <g>
        ...
        <path class="fio-500" stroke="#2D3F5B" stroke-linecap="round"
				stroke-width="4"
