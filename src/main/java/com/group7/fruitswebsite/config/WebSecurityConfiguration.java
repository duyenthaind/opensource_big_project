    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                .authorizeRequests()
                    ...
                    .antMatchers("/user-profile/**", "/user-carts/**").hasAnyAuthority(Constants.RoleName.USER.getName(),Constants.RoleName.ADMIN.getName(), Constants.RoleName.SUPER_ADMIN.getName())
                .and()
